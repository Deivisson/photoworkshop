...
$(document).on('ready page:load', function (){
  ...
  $('html,body').animate({scrollTop: 0},250);
	$('#how-work-link, #made-for-who-link, #top-link, #professionals-link,#sign-up-link, #welcome-contact-us-link, #welcome-contact-us-link2, #how-workshop-link').click(function(event) {
   
    $(".how_work,.workshops,.made-for-who,.professionals,.sign-up-container,.contact-us").css("visibility","visible");
    ...
    $('html,body').animate({scrollTop: top},250, function(){
    	...
    	} else if(linkId == "how-workshop-link") {
        $("#step1").addClass("hover");
        $("#welcome-header").addClass("dark");
      }
...
function resizeContainer() {
  ...
  $('#welcome-cover,#welcome-cover-mask, #welcome-how-work, #welcome-made-for-who, #welcome-professionals, #welcome-sign-up, #welcome-contact-us, #welcome-workshops').height(value);
